...
# Tree cover density
cov_tree_cover_2019 <- raster::extract(x=tree_cover_density_2019,y=ct_spatial) %>%
  data.frame()

colnames(cov_tree_cover_2019) <- "tree_cover_2019"
...
#                 imperviousness_2018, noise_2017, pop_2019, tree_cover_2019, distance_to_border)
...
ggplot(data = ct_cov, mapping = aes(x = Station, y = tree_cover_2019)) + 
  geom_point() + 
  ylim(0, 100) + 
  xlim(0, 100) + 
  labs(title = "New Tree cover density")

ggplot(data = ct_cov, mapping = aes(x = tree_cover_100, y = tree_cover_2019)) + 
  geom_point() + 
  ylim(0, 100) + 
  xlim(0, 100) + 
...
#ggsave(here::here("plots", "01_environmental_variables", "ct_correlation_20230126.png"), width = 12, height = 9)

# Light correlates with imperviousness, population density and distance to border. It is not used for further analysis.
# Population density and distance to border are correlated. We test each of the variables in a separate model.
