...
ggplot(data = env_var, mapping = aes(x = Station, y = tree_cover_2019)) +
  geom_point(colour = "#303B4A") +
  scale_y_continuous(
    limits = c(0, 100),
    breaks = seq(0, 100, by = 25),
...
ggplot(data = env_var, mapping = aes(x = Local_tree_cover, y = tree_cover_2019)) + 
  geom_point() + 
  ylim(0, 100) + 
...
# Tree cover density
ggplot(data = env_var, mapping = aes(x = dogs_binary, y = tree_cover_2019)) + 
  stat_halfeye(mapping = aes(
    color = dogs_binary, 
    fill = dogs_binary),
  width = 0.7, 
...
ggplot(data = env_var, mapping = aes(x = cats_binary, y = distance_to_border)) + 
  ...
  labs(x = "Cat", 
       y = "Distance to border", 
       title = "Cts vs Distance to border") + 
  theme_pubr() + 
  theme(panel.grid.minor = element_blank(),
        panel.grid.major.y = element_blank(), 
        legend.position = "none", 
...
# Tree cover density
ggplot(data = env_var, mapping = aes(x = cats_binary, y = tree_cover_2019)) + 
  stat_halfeye(mapping = aes(
    color = cats_binary, 
    fill = cats_binary),
  width = 0.7, 
...
# Tree cover density
ggplot(data = env_var, mapping = aes(x = trees_of_interest, y = tree_cover_2019)) + 
  stat_halfeye(mapping = aes(
    color = trees_of_interest, 
    fill = trees_of_interest),
  width = 0.7, 
