...
#Circular plots !!
# code before this is not needed
#during No covid
```{r}
# create activity overlap plot
# define species of interest
...
d_overlap_CD_1 <- activityOverlap(recordTable = d1_1,
  ...
  #cat and cat Dhat1 = 0.89
  A <- cbind(d_overlap_AB_1[,c(1:2)], species = speciesA) # horizontal, vertical axis for species A
  B <- cbind (d_overlap_AB_1[,c(1,3)], species = speciesB) # same horizntal, but vertical axis for species B
