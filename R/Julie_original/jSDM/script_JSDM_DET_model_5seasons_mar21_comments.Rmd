...
##### Results: 
environmentan variables afect on presence (binary detection/non detection) use (amount of pics that are taken)
variance partitioning
species association (if species are pos or neg correlated)
